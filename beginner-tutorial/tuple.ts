...
//düz array: 
// var student: (number | string)[] = [101, "smith", 102, "scoot", 103, "mary"];
...
//** Tuple vs Array */
//düz array:  eleman sayısı onemli degil, sıralama serbest
/* var student: (number | string)[] = [101, "smith", 102, "scoot", 103, "mary"];

//Tuple:Sabit sayıda ve sıralı elemanlardan oluşur.3 eleman ve sırayla number,string,number olmak zorunda
var employee:[number,string,number]=[101,"John",50000];

// Tuple Array: Bir array içinde birden fazla tuple barındırabilir
var student: [number, string][] = [
    [101, "smith"],
    [102, "scoot"],
    [103, "mary"]
