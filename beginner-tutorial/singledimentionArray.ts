...
var fruits1:string[]=["mango","apple","banana"] //declare + initialization

//or
var fruits2:Array<string>; //declare
...
//**Multi Type Array */
var values1:(string | number)[]=["mango",100,"orange",200];
//or
var values2:Array<string | number>=["banana",100,"apple",200];
console.log(values1);
console.log(values2);
